            ...
            <CardContent className="p-3 md:p-6 pt-0">
              {!simState.isRunning ? (
                <div className="text-center py-6 md:py-8 text-muted-foreground">
                  ...
                  <p className="text-sm md:text-base">Start Rush Hour simulation to see live statistics</p>
                </div>
              ) : (
                <div className="grid grid-cols-3 gap-2 md:gap-4">
                  <div className="text-center p-2 md:p-4 rounded-lg bg-muted/50">
                    <Car className="h-5 w-5 md:h-6 md:w-6 mx-auto mb-1 md:mb-2 text-primary" />
                    <p className="text-lg md:text-2xl font-bold font-mono">{lots?.length || 0}</p>
                    <p className="text-[10px] md:text-sm text-muted-foreground">Total Lots</p>
                  </div>
                  <div className="text-center p-2 md:p-4 rounded-lg bg-status-violating/10">
                    <AlertTriangle className="h-5 w-5 md:h-6 md:w-6 mx-auto mb-1 md:mb-2 text-status-violating" />
                    <p className="text-lg md:text-2xl font-bold font-mono text-status-violating">
                      {activeLots}
                    </p>
                    <p className="text-[10px] md:text-sm text-muted-foreground">Violating</p>
                  </div>
                  <div className="text-center p-2 md:p-4 rounded-lg bg-primary/10">
                    <Activity className="h-5 w-5 md:h-6 md:w-6 mx-auto mb-1 md:mb-2 text-primary" />
                    <p className="text-lg md:text-2xl font-bold font-mono">{simState.eventsGenerated}</p>
